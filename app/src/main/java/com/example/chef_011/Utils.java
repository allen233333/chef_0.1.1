...
public class Utils {
    ...
    private void initData()
    {
        ...
        allrecipes.add(new Recipe(6,"1 Hour","Gyro",
                ...
                "Lunch"));
        allrecipes.add(new Recipe(7,"40 Minutes","Mac & Cheese",
                ...
                "Dinner"));
        allrecipes.add(new Recipe(8,"35 Minutes","Mashed Potatoes",
        ...
        allrecipes.add(new Recipe(10,"15 Minutes","Omelette",
                ...
                "Breakfast"));
        allrecipes.add(new Recipe(11,"20 Minutes","Pancakes",
